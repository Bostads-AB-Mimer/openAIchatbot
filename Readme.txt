...
Create a .env file in the root directory and populate the required environment variables. Refer to the .env.sample file for reference.
...
Built by David Lindblom: https://github.com/lindblomdavid